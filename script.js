...
function validateuserName(){
    if (username.value.trim()==''){
        emailerror.innerHTML = '<p style= "color:red">Username cant blank</p>';
        return false
    }
...
function validatepass(){
    if (password.value.trim()==''){
        passerror.innerHTML = '<p style= "color:red">Password cant blank</p>';
        return false
    }
    else if(password.value == 12345){
        passerror.innerHTML = '<p style= "color:green">validated</p>';
        return true
    }
    else if(username.value.length>1){
